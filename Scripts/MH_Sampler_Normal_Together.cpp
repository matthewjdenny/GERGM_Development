...
namespace mjd {
  ...
  // Define a function to draw from a beta distribution, source indicated below:
  // http://stackoverflow.com/questions/15165202/random-number-generator-with-
  // beta-distribution
    ...
    for (int i = 0; i < number_of_nodes; ++i) {
      for (int j = 0; j < number_of_nodes; ++j) {
        if (i != j) {
            ...
            std::normal_distribution<double> proposal(current_edge_value,variance);
            int in_zero_one = 0;
